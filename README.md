...
greeting_has_pipe("Ada|")  # True
greeting_has_pipe("Ada")  # False
...
`greeting_has_pipe` checks for a literal `|` in the completed greeting and uses the same name validation as `greet`.
