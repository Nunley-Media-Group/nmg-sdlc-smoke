...
greeting_has_tilde("Ada~")  # True
greeting_has_tilde("Ada")  # False
...
`greeting_has_tilde` checks for a literal `~` in the completed greeting and uses the same name validation as `greet`.
