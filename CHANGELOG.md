...
- Add public greeting_has_asterisk helper (#155)
...
- Add public greeting_has_hash helper (#138)
...
- Add greeting_has_question_mark library probe (#123)

## [3.37.0] - 2026-09-23

### Changed

- Add greeting_has_colon library helper (#120)
...
- Add opt-in `nmg-smoke --quotes` to wrap each fully composed greeting after braces and before repeat/newline output, preserving absent-flag behavior (#109).

### Changed

- Add nmg-smoke --quotes flag for nmg-sdlc #379 verification (#109)
...
- Add casefolded greeting helper (#90)
...
- Add LIVE_SMOKE_362_A verification marker (#82)
...
- Add greeting_starts_with_hello library function (#68)

## [3.23.0] - 2026-09-01

### Changed

- Add greet_many library API (#40)
...
- Add nmg-smoke --no-newline flag (#58)

## [3.20.0] - 2026-09-01

### Changed

- Add greeting_is_ascii library function (#57)
...
- Add greeting_length library function (#44)
...
- Add LIVE_SMOKE_214_C success-path marker (#31)
...
- Added the disposable byte-exact `LIVE_SMOKE_259_B.txt` controller-remediation lifecycle marker.
...
- Added the byte-stable `LIVE_SMOKE_D.txt` fourth serial lifecycle smoke marker, public documentation, and deterministic contract coverage.

## [3.8.0] - 2026-08-25

### Changed

- Added the byte-stable `LIVE_SMOKE_C.txt` third serial lifecycle marker, public documentation, and deterministic contract coverage.

## [3.7.0] - 2026-08-24

### Changed

- Added the byte-stable `LIVE_SMOKE_B.txt` second serial lifecycle marker, public documentation, and deterministic contract coverage.
