Feature: Detect a literal opening brace in a completed greeting

  @SCN001
  Scenario: Opening brace occurs in the completed greeting
  ...
  @SCN002
  Scenario: Neither an ordinary name nor a closing brace matches
