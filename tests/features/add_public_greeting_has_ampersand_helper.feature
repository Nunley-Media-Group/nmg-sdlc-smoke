Feature: Detect a literal ampersand in a completed greeting

  @SCN001
  Scenario: ASCII ampersand occurs in the completed greeting
  ...
  @SCN002
  Scenario: ASCII ampersand is absent from completed greetings
