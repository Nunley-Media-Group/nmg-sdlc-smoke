...
scenarios("../add_public_greeting_has_equal_helper.feature")
...
def public_exports_and_script(context: dict[str, object]) -> None:
    context["exports"] = (
        ...
        greeting_has_at_sign, greeting_has_colon, greeting_has_hash,
        greeting_has_percent, greeting_has_question_mark,
        greeting_has_semicolon, greeting_is_ascii, greeting_length,
        greeting_starts_with_hello, greeting_word_count, greeting_has_equal,
    )
